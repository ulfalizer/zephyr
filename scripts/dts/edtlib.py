...
class Device:
    ...
    interrupts:
      A list of (<controller>, {name: value, name: value: ...}) tuples, giving
      the interrupts generated by the device.

      <controller> is the target of the interrupt (after mapping through any
      interrupt-map properties), and {name: value, name: value, ...} the
      interrupt specifier cell values, e.g. {'irq': 1, 'level': 2}. The names
      are taken from the #cells field in the binding for the interrupt
      controller.
